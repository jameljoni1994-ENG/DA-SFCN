...
\end{lemma}
\begin{proof}
إذا $T=U\Lambda U^\top$ و$z=U^\top s$ فإن
...
\end{theorem}
\begin{proof}
نقطة كوشي على $-\tau g_k$ مقبولة دائمًا في فضاء كريلوف. تنازل
\textenglish{ARC} من رتبة $\|g_k\|^{3/2}$ يجمع إلى المعدل $K^{-2/3}$.
التفاصيل: \texttt{pdfs/08\_Theory\_AR.pdf}.
\end{proof}
\begin{theorem}
...
\end{theorem}
\begin{proof}
نيوتن غير الدقيق + حد تشيبيشيف + جدولة لوغاريتمية لـ $m_k$ تجعل بواقي
كريلوف $O(\|e_k\|^2)$.
\end{proof}
